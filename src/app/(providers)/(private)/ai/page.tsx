        ...
        <div className="flex h-full flex-col">
          ...
          {!hasMessages ? (
            <div className="flex w-full flex-wrap items-center justify-center gap-2 p-2 lg:min-h-[calc(100vh-24rem)] lg:gap-4 lg:p-4">
              <button
                onClick={() =>
                  handleButtonClick("Gerar Insights Personalizados")
                }
            ...
            <div
              id="container"
              className="flex h-[calc(100vh-24rem)] max-h-[calc(100vh-24rem)] w-full flex-col gap-4 overflow-y-scroll px-2 py-4"
            >
              {userMessages.map((message, index) =>
                message.role === "user" ? (
                  <div
                    key={index}
                    className="ml-auto flex w-max max-w-[calc(100%-50px)] flex-col items-start justify-center rounded-2xl bg-gray-200 px-8 py-2"
                  >
