    ...
    <div className="rounded-md bg-white p-5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-row items-center gap-4">
          <button className="rounded-md bg-sky-600 px-5 py-2 text-sm text-white">
            {buttonText}
          </button>
          {hasTwoButtons && (
            <button className="flex items-center gap-2 rounded-md bg-green-700 px-2 py-2 text-sm text-white">
              {secondButtonText}
              <PlusCircle size={20} />
            </button>
          )}
