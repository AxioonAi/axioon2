  ...
  useEffect(() => {
    if (activeUserData) {
      ...
      setActiveTiktokSentiment(
        activeUserData.commentsData.currentSentiment.tiktok,
      );
      setActiveYoutubeSentiment(
        activeUserData.commentsData.currentSentiment.youtube,
      );
    }
  }, [activeUserData]);
  ...
  useEffect(() => {
    if (passiveUserData) {
      ...
      setPassiveTiktokSentiment(
        passiveUserData.commentsData.currentSentiment.tiktok,
      );
