...
export function ProtestList({ ProtestListData }: ProtestListProps) {
  ...
  return (
    <BaseCard className="p-0">
      ...
      <div className="mb-12 flex h-[50vh] w-full flex-col justify-around gap-4 overflow-scroll p-4 pb-10 text-[10px] lg:h-full xl:text-xs 2xl:text-sm 3xl:text-base">
                ...
                item.data.map((data, index) => (
                  ...
                  >
                    ...
                    <div className="col-span-2 flex flex-col">
                      ...
                      <span className="font-semibold">
                        {new Date(data.protestDate).toLocaleDateString("pt-BR")}
                      </span>
                    </div>
                    <div className="col-span-2 flex flex-col">
                      <span className="text-zinc-500">Data de Vencimento</span>
                      <span className="font-semibold">
                        {new Date(data.expiryDate).toLocaleDateString("pt-BR")}
                      </span>
                    </div>
                    <div className="col-span-2 flex flex-col">
