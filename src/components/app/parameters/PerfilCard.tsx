        ...
        <div className="flex flex-col">
          <div className="flex flex-row items-center justify-between">
            ...
            <button
              ...
              className="flex cursor-pointer flex-row items-center justify-between gap-1 rounded-lg bg-sky-100 px-1 py-0.5 text-sm font-bold text-sky-700 transition-colors hover:bg-sky-200"
            >
              Ajustes
              <Image
                className="h-6 w-6"
