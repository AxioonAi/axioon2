...
interface HashtagsMentionsMainInfluencersProps {
  createdAt: string;
  engagement: number;
  followers: number;
  id: string;
...
export function HashtagsMentionsMainInfluencers() {
  const [InstagramInfluencersData, setInstagramInfluencersData] = useState<
    HashtagsMentionsMainInfluencersProps[]
  >([]);
  const [TikTokInfluencersData, setTikTokInfluencersData] = useState<
    HashtagsMentionsMainInfluencersProps[]
  >([]);
  ...
  useEffect(() => {
    if (InstagramInfluencersData && TikTokInfluencersData) {
      setInfluencersData([
        ...InstagramInfluencersData,
        ...TikTokInfluencersData,
      ]);
    }
  }, [InstagramInfluencersData, TikTokInfluencersData]);
