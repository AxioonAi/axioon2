...
interface MentionsDonutGraphProps {
...
export function MentionsDonutGraph({
  MentionsDonutGraphData,
}: MentionsDonutGraphProps) {
  return (
    <BaseCard className="p-0">
      ...
      <DonutChartWithFooterData
        ChartOptions={MentionsDonutGraphData.ChartOptions}
        footerData={MentionsDonutGraphData.footerData.map((data) => {
          return (
