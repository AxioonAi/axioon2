...
export function HashtagsCommentsSummary() {
  ...
  useEffect(() => {
    if (hashtagData) {
      setInstagramCommentsData(
        hashtagData.hashtagMentions.commentData.commentBySentiment.instagram,
      );
      setTiktokCommentsData(
        hashtagData.hashtagMentions.commentData.commentBySentiment.tiktok,
      );
    }
  }, [hashtagData]);

  useEffect(() => {
    const commentsBySentiment = [instagramCommentsData, tiktokCommentsData];
  ...
  }, [instagramCommentsData, tiktokCommentsData]);
